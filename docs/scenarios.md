# Climate Scenarios — ZWE

---

## AR6 Scenario Coverage — R10AFRICA

This model incorporates climate scenario drivers from the IPCC AR6 database for the **R10AFRICA**
...
| **Regional Scope** | R10AFRICA | IPCC R10 regional classification |
...
<div align="center">
  <img src="assets/ar6_scenarios_ZWE.png"
...
from $180 to $0/tCO₂ by 2030 under ambitious vs. limited
action scenarios. By 2050, this gap widens to $605–$0/tCO₂.

**Electrification Acceleration:** Total electricity demand grows by 8.3× under
ambitious climate scenarios (C1) compared to 5.7× under limited action (C7)
...
- **High Convergence** — CO₂ pricing (CV: inf%) and electricity growth (CV: 46.9%)
- **Moderate Uncertainty** — Transport electrification rates (CV: 102.3%)
- **High Divergence** — Hydrogen deployment pathways (CV: 86.7%)

The **R10AFRICA** region shows moderate convergence compared to global averages,
