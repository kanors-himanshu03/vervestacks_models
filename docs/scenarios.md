# Climate Scenarios — MYS

---

## AR6 Scenario Coverage — R10REST_ASIA

This model incorporates climate scenario drivers from the IPCC AR6 database for the **R10REST_ASIA**
...
| **Regional Scope** | R10REST_ASIA | IPCC R10 regional classification |
...
<div align="center">
  <img src="assets/ar6_scenarios_MYS.png"
...
from $187 to $0/tCO₂ by 2030 under ambitious vs. limited
action scenarios. By 2050, this gap widens to $582–$0/tCO₂.

**Electrification Acceleration:** Total electricity demand grows by 3.7× under
ambitious climate scenarios (C1) compared to 2.9× under limited action (C7)
by 2050, reflecting massive sectoral electrification across transport, heating, and industry.

**Hydrogen Integration:** Hydrogen deployment reaches 0.1% of electricity
...
- **High Convergence** — CO₂ pricing (CV: inf%) and electricity growth (CV: 33.6%)
- **Moderate Uncertainty** — Transport electrification rates (CV: 71.4%)
- **High Divergence** — Hydrogen deployment pathways (CV: inf%)

The **R10REST_ASIA** region shows moderate convergence compared to global averages,
