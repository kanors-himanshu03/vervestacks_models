...
## Malaysia Hydro Profile

| Planning Parameter | Value | Application |
|--------------------|-------|-------------|
| **Hydro Dependency** | 16.8% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 37.4% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 39.6% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 42.2% annual average | Export opportunities, minimum backup |
| **Historical Average** | 38.6% (2000-2023) | Validation benchmark |
| **Drought Threshold** | 30.0% (P20 of historical) | Operational stress indicator |
...
<div align="center">
  <img src="assets/MYS_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/MYS_hydro_annual_trajectory.png"
