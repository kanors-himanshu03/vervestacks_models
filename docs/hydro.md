...
## Croatia Hydro Profile

| Planning Parameter | Value | Application |
|--------------------|-------|-------------|
| **Hydro Dependency** | 39.3% of generation | System vulnerability assessment |
| **P10 (Dry Scenario)** | 26.3% annual average | Security planning, reserve sizing |
| **P50 (Base Scenario)** | 28.2% annual average | Expected case, financial planning |
| **P90 (Wet Scenario)** | 29.9% annual average | Export opportunities, minimum backup |
| **Historical Average** | 35.4% (2000-2023) | Validation benchmark |
| **Drought Threshold** | 28.9% (P20 of historical) | Operational stress indicator |
...
<div align="center">
  <img src="assets/HRV_hydro_monthly_profile.png"
...
<div align="center">
  <img src="assets/HRV_hydro_annual_trajectory.png"
