# Renewable Energy Potential — MYS
...
<div align="center">
  <img src="assets/supply_curves_MYS.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 206 | 24 | 8.6 cells | 5 to 16 cells |
| 💨 **Wind Onshore** | 22 | 10 | 2.2 cells | 1 to 4 cells |
| 🌊 **Wind Offshore** | 36 | 10 | 3.6 cells | 2 to 8 cells |

**Grid Definition:** Cities as transmission bus proxies
...
<div align="center">
  <img src="assets/clustering_results_MYS_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 24 clusters from 206 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_MYS_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 10 clusters from 22 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_MYS_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 10 clusters from 36 grid cells</em></p>
</div>
