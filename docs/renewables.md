# Renewable Energy Potential — ZWE
...
<div align="center">
  <img src="assets/supply_curves_ZWE.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 179 | 22 | 8.1 cells | 4 to 14 cells |
| 💨 **Wind Onshore** | 156 | 20 | 7.8 cells | 2 to 16 cells |
...
<div align="center">
  <img src="assets/clustering_results_ZWE_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 22 clusters from 179 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_ZWE_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 20 clusters from 156 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_ZWE_wind_offshore.png"
