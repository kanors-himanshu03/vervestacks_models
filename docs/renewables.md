# Renewable Energy Potential — JPN
...
<div align="center">
  <img src="assets/supply_curves_JPN.svg"
...
|------------|-----------|---------|-----------------|------------|
| ☀️ **Solar PV** | 299 | 30 | 10.0 cells | 3 to 22 cells |
| 💨 **Wind Onshore** | 310 | 31 | 10.0 cells | 2 to 21 cells |
| 🌊 **Wind Offshore** | 549 | 44 | 12.5 cells | 3 to 26 cells |
...
<div align="center">
  <img src="assets/clustering_results_JPN_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 30 clusters from 299 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_JPN_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 31 clusters from 310 grid cells</em></p>
</div>

### Wind Offshore Clustering

<div align="center">
  <img src="assets/clustering_results_JPN_wind_offshore.png"
       alt="Offshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Offshore: 44 clusters from 549 grid cells</em></p>
</div>
