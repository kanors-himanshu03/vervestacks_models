# Renewable Energy Potential — HRV
...
<div align="center">
  <img src="assets/supply_curves_HRV.svg"
...
| 💨 **Wind Onshore** | 73 | 13 | 5.6 cells | 4 to 10 cells |
| 🌊 **Wind Offshore** | 70 | 12 | 5.8 cells | 2 to 11 cells |
...
<div align="center">
  <img src="assets/clustering_results_HRV_solar.png"
       alt="Solar PV Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Solar PV: 15 clusters from 100 grid cells</em></p>
</div>

### Wind Onshore Clustering

<div align="center">
  <img src="assets/clustering_results_HRV_wind_onshore.png"
       alt="Onshore Wind Clustering" style="max-width:100%; border:1px solid #ddd; border-radius:8px;">
  <p><em>Wind Onshore: 13 clusters from 73 grid cells</em></p>
</div>
...
<div align="center">
  ...
  <p><em>Wind Offshore: 12 clusters from 70 grid cells</em></p>
</div>
