...
<div align="center">
  <img src="assets/HRV_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 25 | Transmission substations and connection points |
| **Transmission Lines** | 27 | High-voltage transmission corridors |

## Power Plant Integration

| Integration Type | Count | Description |
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 168 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 243 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 107 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 102 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 209 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 10 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/HRV_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/89820062-220 (0.432 share)
- **Load Distribution CV:** 116.7% (coefficient of variation across buses with non-zero demand)
