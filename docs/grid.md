...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 10054 | GEM power plants assigned to grid locations |
...
| **Solar / Wind Onshore Zones** | 420 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 626 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 1046 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 40 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/JPN_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** relation/2269992-500 (0.362 share)
- **Load Distribution CV:** 240.2% (coefficient of variation across buses with non-zero demand)
