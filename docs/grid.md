...
|--------|-------|-------------|
| **Total Buses** | 16 | Transmission substations and connection points |
| **Transmission Lines** | 25 | High-voltage transmission corridors |
...
- **Highest Load Bus:** way/420797421-765 (0.138 share)
- **Load Distribution CV:** 52.5% (coefficient of variation across buses with non-zero demand)
