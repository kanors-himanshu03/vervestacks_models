...
<div align="center">
  <img src="assets/ZWE_network_visualization.svg"
...
|--------|-------|-------------|
| **Total Buses** | 26 | Transmission substations and connection points |
| **Transmission Lines** | 32 | High-voltage transmission corridors |

## Power Plant Integration

| Integration Type | Count | Description |
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 100 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 188 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 186 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 0 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 188 | REZoning zones assigned to transmission buses |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 5 | 1.0 | Population-weighted clusters mapped to nearest buses |

<div align="center">
  <img src="assets/ZWE_demand_bus_verification.png"
       alt="Demand-region to bus mapping verification" style="max-width:100%;">
</div>

### Load Concentration

- **Highest Load Bus:** way/200797322-330 (0.564 share)
- **Load Distribution CV:** 95.6% (coefficient of variation across buses with non-zero demand)
