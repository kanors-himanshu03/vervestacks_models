...
|------------------|-------|-------------|
| **Plants Mapped to Buses** | 350 | GEM power plants assigned to grid locations |
...
|----------------|-------|--------|
| **Grid Cells** | 1420 | 50×50 km renewable energy zones |
| **Solar / Wind Onshore Zones** | 1420 | Grid cells with solar and onshore wind potential |
| **Wind Offshore Zones** | 0 | Grid cells with offshore wind potential |
| **Zone–Bus Mappings** | 1420 | REZoning zones assigned to transmission buses |
...
- **Load Distribution CV:** 185.8% (coefficient of variation across buses with non-zero demand)
