...
|--------|-------|-------------|
| **Total Buses** | 12 | Transmission substations and connection points |
...
|--------------------------|-----------------|-----------------|-------------|
| **Demand-Region Clustering** | 12 | 1.0 | Population-weighted clusters mapped to nearest buses |
...
- **Load Distribution CV:** 46.5% (coefficient of variation across buses with non-zero demand)
